...
public class MockDataCreator {
    ...
    List<Offer> offers;
    List<OfferConfiguration> offerConfigurations;
    ...
    public void createMockData() {
        ...
        System.out.println(caretakerRepository.findAll().get(0).getOffers().get(0).getAnimal());
        System.out.println(caretakerRepository.findAll().get(0).getOffers().get(0).getOfferConfigurations());
