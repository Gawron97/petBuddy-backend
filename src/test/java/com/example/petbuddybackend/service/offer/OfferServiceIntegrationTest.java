...
public class OfferServiceIntegrationTest {
        ...
        return Stream.of(
                ...
                Arguments.of(
                        ModifyOfferDTO.builder()
                                ...
                                .animalAmenities(new HashSet<>(List.of("secured garden", "toys")))
                                .build(),
                        true , // Expected to be an existing offer
                        2, // Expected number of configurations after addition
                ...
                Arguments.of(
                        ModifyOfferDTO.builder()
                                .description("Third Configuration")
                                .animal(AnimalDTO.builder().animalType("DOG").build())
                                .animalAmenities(new HashSet<>(List.of("secured garden")))
                                .build(),
                        true , // Expected to be an existing offer
                        1, // Expected number of configurations after addition
                        2 // Expected number of animal amenities
    ...
    void setAmenitiesForOffer_ShouldAddAmenitiesProperly() {
        ...
        //Given
        Set<String> amenitiesToSet = Set.of("secured garden");
    ...
    void setAmenitiesForOffer_whenAddingDuplicateAmenity_ShouldSkipDuplicatedAmenityAndAddUnique() {
        ...
        //Given
        Set<String> amenitiesToSet = Set.of("toys", "secured garden");
    ...
    void deleteAmenitiesFromOffer_ShouldDeleteAmenitiesFromOffer() {
        ...
        PersistenceUtils.addConfigurationAndAmenitiesForOffer(
                ...
                List.of(
                        animalAmenityRepository.findByAmenity_NameAndAnimal_AnimalType("toys", "DOG").orElseThrow(),
                        animalAmenityRepository.findByAmenity_NameAndAnimal_AnimalType("secured garden", "DOG").orElseThrow()
                ),
                offerRepository
        );
